...
def run_test() -> None:
    ...
    try:
        ...
        print_labeled_output(
            'PASSED',
            'Your "project0_1.py" passed the sanity checker.  Note that there are',
...
def start_process() -> TextProcess:
    ...
    if not 'project0_1.py' in filenames_in_dir:
        print_labeled_output(
            'ERROR',
            'Cannot find file "project0_1.py" in this directory.',
            'Make sure that the sanity checker is in the same directory as the',
            '"project0_1.py" that comprises your Project #0 solution.  Also, be',
            'sure that you\'ve named your "project0_1.py" file correctly, noting',
        ...
        return TextProcess(
            [sys.executable, str(pathlib.Path.cwd() / 'project0_1.py')],
